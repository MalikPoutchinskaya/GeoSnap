                            ...
                            if (showResult) {
                                ...
                                Box(
                                    ...
                                    Texts.Title(
                                        ...
                                        text = stringResource(
                                            R.string.geoGuesserScreen_result_text,
                                            distance.toString()
                                        ),
                                        color = textColor
                                    )
...
private fun BottomBar(
    ...
    if (isFinished.not()) {
        val text = when {
            isRevealed -> stringResource(R.string.geoGuesserScreen_button_next)
            else -> stringResource(R.string.geoGuesserScreen_button_reveal)
        }
